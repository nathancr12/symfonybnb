...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être utlérieure à la date d'aujourd'hui", groups={"front"})
     */
    private $startDate;
    ...
    public function isBookableDates(){
        // connaître les dates impossibles pour l'annonce (voir dans Ad)
        $notAvailableDays = $this->ad->getNotAvailableDays();
        // comparer les dates choisies avec les dates impossibles 

        $bookingDays = $this->getDays();

        // transformation des objets DateTime en tableau de chaînes de caractères pour les journées (faciliter la comparaison)
